...
function mgf( t, options ) {
	...
	if ( isTypedArrayLike( t ) ) {
		...
		return mgf6( out, t, opts.k );
	}
	if ( isArrayLike( t ) ) {
		// Handle deepset first...
		if ( opts.path ) {
			opts.sep = opts.sep || '.';
			return mgf4( t, opts.k, opts.path, opts.sep );
		}
		...
		if ( opts.accessor ) {
			return mgf3( out, t, opts.k, opts.accessor );
		}
		return mgf2( out, t, opts.k );
	}
	return NaN;
} // end FUNCTION mgf()
